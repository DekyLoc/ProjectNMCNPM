...
namespace QLKS.GUI
{
    public partial class GUI_TraCuu : Form
    {
        ...
        {
            InitializeComponent();
            TraCuu_BUS= new BUS_TraCuu();
            TraCuu_DTO = new DTO_TraCuu();
        ...
        private BUS_TraCuu TraCuu_BUS;
        private DTO_TraCuu TraCuu_DTO;
        #endregion
        ...
        void HirePhong()
        {
            ...
            QLKS.Container.isReturnTraCuu = true;
        ...
        void ChoosePhongToHire()
        {
            ...
            QLKS.Container.selectedPhong = selectedItem.Text;
        }
        ...
        {
            DataTable dataTable = new DataTable();
            dataTable = TraCuu_BUS.FindPhieuThue();
        ...
        {
            DataTable dataTable = new DataTable();
            dataTable = TraCuu_BUS.FindHoaDon();
            DataTable dataTablePT = new DataTable();
            dataTablePT = TraCuu_BUS.FindPhieuThue();
            ...
            if (rbtnNgayTra.Checked == true)
            {
                ...
                for (int i = 0; i < dataTable.Rows.Count; i++)
                {
                    ...
                    if (datetimeNgayTra.Day.ToString() == cmbNgayHD.Text && string.IsNullOrEmpty(cmbThangHD.Text))
                    {
                        ...
                        item.SubItems.Add(new ListViewItem.ListViewSubItem() { Text = QLKS.Container.FormatMoney(Int32.Parse(dataTable.Rows[i][5].ToString())) });
